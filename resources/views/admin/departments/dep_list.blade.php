              ...
              <div class="card-header" style="background: #ddd;">  
                <div class="row">  
                  ...
                  <div class="col-md-3 text-right"> 
                    ...
                    <a href="{{ route('departments.add') }}" class="btn btn-primary waves-effect waves-light"><i class="fe-plus-square"></i> เพิ่ม </a> 
                  </div>
                </div>
              </div>
              <div class="card-body">  
                <div class="h5"> ตารางข้อมูลแผนกประจำวันที่ {{ date('m/d/Y') }} </div> 
                <div class="table-responsive"> 
                  <table class="table table-borderless dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;" id="tbl-departments">
                    <thead>
                      <tr> 
...
<script> 
  ...
  function datatable(keywrod, status){  
    var table = $('#tbl-departments').DataTable({
      ...
      "lengthChange": true, 
      ajax: {
        url:"{{ route('datatable.departments') }}", 
        data:{
          keywrod: keywrod, 
          status: status,
        }
